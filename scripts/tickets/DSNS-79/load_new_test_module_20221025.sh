...
#ard_loc='/g/data/u46/users/$USER/sandbox/dea-ard-scene-select/scripts/prod/ard_env/prod-wagl.env'
...
#ard_loc_dev="/g/data/u46/users/$USER/sandbox/dea-ard-scene-select/scripts/examples/prod-wagl.env"
ard_loc_dev="/g/data/u46/users/$USER/dea-ard-scene-select/scripts/examples/prod-wagl.env"
