...
ard-scene-select --workdir /g/data/v10/work/c3_ard/workdir --pkgdir /g/data/xu18/ga --logdir /g/data/v10/work/c3_ard/logdir --env $1/prod-wagl.env --index-datacube-env $1/index-datacube.env  --project v10 --walltime 05:00:00 --run-ard
