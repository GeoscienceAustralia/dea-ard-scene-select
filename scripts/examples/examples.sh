...
time python3 ../../scene_select/ard_scene_select.py --workdir scratch/  --pkgdir  scratch/ --logdir scratch/    --project u46 --walltime 05:00:00  --products '["usgs_ls8c_level1_2"]' --find-blocked #--run-ard  # --products '["usgs_ls8c_level1_1"]' --env /g/data/v10/projects/c3_ard/dea-ard-scene-select/scripts/prod/ard_env/prod-wagl.env --index-datacube-env $PWD/c3-samples-index-datacube.env
