...
../../scene_select/ard_scene_select.py --workdir $PWD/workdir --pkgdir $PWD/pkgdir --logdir $PWD/logdir --env $PWD/prod-wagl.env  --project u46 --walltime 03:00:00 #--run-ard --index-datacube-env $PWD/c3-samples-index-datacube.env
