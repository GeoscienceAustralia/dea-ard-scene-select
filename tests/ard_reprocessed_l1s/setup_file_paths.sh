...
#echo "---->>> Just added the dataset ....."
# datacube system check 
datacube system check  |grep -oP '^Host:\s+\S+:(\d+)'
#echo " Going to search... "
#datacube  $ODCCONF dataset search product='ga_ls9c_ard_3'
...
echo "Just made the scratch dir"
