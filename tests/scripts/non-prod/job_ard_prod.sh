...
# A module
ard-scene-select --products '["usgs_ls7e_level1_1"]' --workdir $INIT_PWD/scratch/ --pkgdir $INIT_PWD/scratch/ --logdir $INIT_PWD/scratch/ --env $INIT_PWD/prod-20201030.env --index-datacube-env $INIT_PWD/dsg547_dev.env  --project u46 --walltime 10:00:00  #--config $INIT_PWD/dsg547_dev.conf  # --run-ard # note will try and index
