...
#  local work dir
# python3 ard_scene_select.py --workdir scratch/  --pkgdir  scratch/ --logdir scratch/ --env /g/data/v10/Landsat-Collection-3-ops/OFFICIAL/Collection-3_5.4.1.env --project v10 --walltime 05:00:00 --landsat-AOI #--run-ard

# local work dir and skipping odc
python3 ard_scene_select.py --usgs-level1-files data/small_Landsat_Level1_Nci_Files.txt --workdir scratch/  --pkgdir  scratch/ --logdir scratch/ --project v10 --walltime 05:00:00 --landsat-AOI #--run-ard
...
# using Landsat AOI
#python3 ard_scene_select.py  --usgs-level1-files data/All_Landsat_Level1_Nci_Files.txt  --workdir scratch/ --landsat-AOI
