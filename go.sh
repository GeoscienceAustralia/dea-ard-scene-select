...
#python3 region_code_filter.py --products '["ga_ls5t_level1_3", "usgs_ls5t_level1_1", "usgs_ls7e_level1_1", "usgs_ls8c_level1_1"]' --workdir $PWD  --pkgdir $PWD --logdir $PWD --env /g/data/v10/Landsat-Collection-3-ops/OFFICIAL/Collection-3_5.4.1.env --project v10 --walltime 05:00:00 #--run-ard

# skipping odc
python3 region_code_filter.py  --usgs-level1-files data/small_Landsat_Level1_Nci_Files.txt --workdir  scratch/ --pkgdir scratch/ --logdir scratch/  #--run-ard
